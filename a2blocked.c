/*
 *        a2blocked.c
 *        Kalina Allen (kallen07) & Elena Cokova (ecokov01)
 *        HW3 - locality
 *        10/06/15
 *
 *        This file contains the implementation of a2methods for uarray2b
 *        This code was supplied & written by COMP40 staff
 */
